...
#c.h = np.array([0,0,0,3,-3])

#c.J = np.array([[0,0,2,-2,0],[0,0,2,2,-2],[2,2,0,1,2],[-2,2,1,0,2],[0,-2,2,2,0]])
#c.h = np.array([-2,0,3,-3,0])

#c = PCircuit(4)

#c.J = np.array([[0,-2,2,2,0,0],[-2,0,2,2,0,0],[2,2,0,0,-1,2],[2,2,0,0,-1,0],[0,0,-1,-1,0,2],[0,0,2,0,2,0]])
#c.h = np.array([0,0,3,-2,1,-2])

#Nonpertutative
#c.J = np.array([[0,-1,-1,2],[-1,0,-1,2],[-1,-1,0,2],[2,2,2,0]])
#c.h = np.array([0,1,1,1])
...
file_path = os.path.join(current_dir, 'output_XOR_red_inv.txt')
